  ...
  return (
    <div className="container mx-auto mt-8 px-4 sm:px-6">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
        <div className="col-span-1 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800 dark:text-white">
          <div className="flex flex-col items-center">
            ...
            <div className="mb-2 mt-2 flex gap-2">
              ...
              <Link 
                href={`/settings/${user.name}/following`}
        ...
        <div className="col-span-3 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800 dark:text-white">
            ...
            <div className="space-y-6">
              {posts && posts.length > 0 ? (
                posts?.map((post: any) => (
                  ...
                  >
                    <div className="flex items-start gap-4 rounded-md border border-gray-200 bg-gray-50 p-4 shadow-sm transition duration-200 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:hover:bg-gray-800">
                      <img
                        src={user.image || "/default-avatar.png"}
                        alt="Avatar"
